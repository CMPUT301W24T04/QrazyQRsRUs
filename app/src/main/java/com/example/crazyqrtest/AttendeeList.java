...
public class AttendeeList extends Fragment implements com.example.crazyqrtest.AddAttendee.AddAttendeeDialogListener {
    /**
...
//            final String attendeeName = attendees[i];
//            final String attendee_checkins = num_checkins[i];
...
//                {
//                    Log.d(TAG, String.valueOf(doc.getData().get("Number of checkins")));
//                    String name = doc.getId();
//                    String num_checkins = (String) doc.getData().get("Number of checkins");
...
//        });
        ...
        attendeeListLayout.findViewById(R.id.button_back).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Navigation.findNavController(attendeeListLayout).navigate(R.id.action_attendeeList_to_organizerMain);
            }
        });
