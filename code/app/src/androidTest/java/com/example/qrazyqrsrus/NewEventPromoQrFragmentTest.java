...
public class NewEventPromoQrFragmentTest {
    ...
    public void testGenerateButtonClick(){
        ...
        FragmentScenario<NewEventPromoQrFragment> scenario = FragmentScenario.launchInContainer(NewEventPromoQrFragment.class, args, R.style.Base_Theme_QrazyQRsRUs, Lifecycle.State.INITIALIZED);
        ...
        onView(withId(R.id.new_event_display_qr_code_promo)).check(matches(hasDrawable()));

        onView(withId(R.id.promo_screen_next_screen)).perform(click());
        ...
        verify(mockNavController).navigate(
                eq(R.id.action_newEventPromoQrFragment_to_newEventQrFragment),
                captor.capture()
        );
        ...
        assertNotNull(builder.getQrCodePromo());
