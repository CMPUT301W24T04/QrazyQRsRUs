...
public class NewEventImageFragment extends Fragment implements Toolbar.OnMenuItemClickListener, ImageDecoder.OnHeaderDecodedListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        assert bundle != null;
        handleArguments(Objects.requireNonNull(bundle), view);
        createToolbar(view);
...
//                        Log.d("PhotoPicker", "Selected URI: " + uri);
                        ...
                        updateImage(uri);
                        this.uri = uri;
                        this.path = generateUniquePathName(((Event.EventBuilder) Objects.requireNonNull(bundle.getSerializable("builder"))).getName());
                    }
                });

        //we set an onclick listener for the upload image button
        //upon clicking, we launch the pickVisualMediaRequest activity
    ...
    public boolean onMenuItemClick(MenuItem item) {
        ...
        if (id == R.id.back_button){
            ...
            args = makeNewBundle(Objects.requireNonNull(args));
            Navigation.findNavController(requireView()).navigate(R.id.action_newEventImageFragment_to_newEventTextFragment, args);
            return true;
        }
        else if (id == R.id.cancel_button){
            //leave entire new event sequence
            Navigation.findNavController(requireView()).navigate(R.id.action_newEventImageFragment_to_newEventFragment);
            return true;
        }
        return false;
    }
    ...
    private void updateImage(Uri uri){
        ...
        try {
            ...
            imageSource = createSource(requireContext().getContentResolver(), uri);
    ...
    private Bundle makeNewBundle(Bundle bundle){
        ...
        if (this.uri == null){
            ...
            if (this.initialPath != null){
                ...
                Objects.requireNonNull(builder).setUri(null);
            ...
            if (this.initialPath == null || !this.initialPath.equals(this.path)){
                ...
                Objects.requireNonNull(builder).setUri(this.uri);
    ...
    private void handleArguments(Bundle args, View view){
        ...
        if (Objects.requireNonNull(builder).getPosterPath() != null){
