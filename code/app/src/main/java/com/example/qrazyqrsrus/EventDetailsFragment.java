...
public class EventDetailsFragment extends Fragment {
    ...
    private void setImages(ImageView posterView, ImageView promoQRView, ImageView checkInQRView){
        if (this.event.getPosterPath() != null) {
            firebaseDB.retrieveImage(this.event, posterView::setImageBitmap);
        }
    ...
    private Uri getUriToShare(Bitmap bitmap){
        Uri uri = null;
        String localFilePath = MediaStore.Images.Media.insertImage(requireContext().getContentResolver(), bitmap, "QrToBeShared", "the qr we are sharing");
